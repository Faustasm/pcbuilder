      ...
      <div class="w3-row">
        <div class="w3-card-1">
         <div class="w3-container w3-center">
           <img
              v-if="selectedMotherboard.image_url && selectedMotherboard.image_url != 'Placeholder'"
              class="w3-margin-top"
              :src="require(`../../assets/products/mb/${selectedMotherboard.image_url}.jpg`)"
              height="100"
          >
           <img
              v-else
          ...
          >
           <p>
             {{selectedMotherboard.model || $t('components.parts.motherboard.notSelected')}}
           </p>
           <p
...
export default {
  ...
  watch: {
    selectedMotherboard (newSelectedMotherboard, oldSelectedMotherboard) {
      if ((newSelectedMotherboard != oldSelectedMotherboard) && this.selectedMotherboard.id) {
        this.getProducts()
      }
    }
  },
