      ...
      <div class="w3-row">
        <div class="w3-card-1">
         <div class="w3-container w3-center">
           <img
              v-if="selectedGraphicsCard.image_url && selectedGraphicsCard.image_url != 'Placeholder'"
              class="w3-margin-top"
              :src="require(`../../assets/products/gpu/${selectedGraphicsCard.image_url}.jpg`)"
              height="100"
          >
           <img
              v-else
          ...
          >
           <p>
             {{selectedGraphicsCard.name || $t('components.parts.graphicsCard.notSelected')}}
           </p>
           <p
...
export default {
  ...
  watch: {
    selectedGraphicsCard (newSelectedGraphicsCard, oldSelectedGraphicsCard) {
      if ((newSelectedGraphicsCard != oldSelectedGraphicsCard) && this.selectedGraphicsCard.id) {
        this.getProducts()
      }
    }
  },
