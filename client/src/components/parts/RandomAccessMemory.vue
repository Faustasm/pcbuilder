      ...
      <div class="w3-row">
        <div class="w3-card-1">
         <div class="w3-container w3-center">
           <img
              v-if="selectedRandomAccessMemory.image_url && selectedRandomAccessMemory.image_url != 'Placeholder'"
              class="w3-margin-top"
              :src="require(`../../assets/products/ram/${selectedRandomAccessMemory.image_url}.jpg`)"
              height="100"
          >
           <img
              v-else
              ...
              height="100"
          >
           <p>{{selectedRandomAccessMemory.model || $t('components.parts.randomAccessMemory.notSelected')}}</p>
           <p
...
export default {
  ...
  watch: {
    selectedGraphicsCard (newSelectedRandomAccessMemory, oldSelectedRandomAccessMemory) {
      if ((newSelectedRandomAccessMemory != oldSelectedRandomAccessMemory) && this.selectedRandomAccessMemory.id) {
        this.getProducts()
      }
    }
  },
