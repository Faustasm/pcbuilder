      ...
      <div class="w3-row">
        <div class="w3-card-1">
         <div class="w3-container w3-center">
           <img
              v-if="selectedProcessor.image_url && selectedProcessor.image_url != 'Placeholder'"
              class="w3-margin-top"
              :src="require(`../../assets/products/cpu/${selectedProcessor.image_url}.jpg`)"
              height="100"
          >
           <img
              v-else
          ...
          >
           <p>
             {{selectedProcessor.name || $t('components.parts.processor.notSelected')}}
           </p>
           <p
...
export default {
  ...
  watch: {
    selectedProcessor (newSelectedProcessor, oldSelectedProcessor) {
      if ((newSelectedProcessor != oldSelectedProcessor) && this.selectedProcessor.id) {
        this.getProducts()
      }
    }
  },
