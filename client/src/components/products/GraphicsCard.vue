        ...
        <div class="w3-card-1">
         <div class="w3-container w3-center">
           <img
              ...
              class="w3-margin-top"
              :src="require(`../../assets/products/gpu/${graphicsCardData.image_url}.jpg`)"
              height="100"
          />
           <img
              v-else
          ...
          <p>
            <img
              class="w3-margin-top"
              :src="require(`../../assets/brand_icons/${graphicsCardData.brands}.svg`)"
              height="15"
            />
          </p>
           <p>
           ...
           <p>{{$t('components.products.graphicsCard.description.pricesLabel')}}:</p>
           <p
...
export default {
  ...
  async created() {
    if (this.id) {
      await axios
        .get(
          'http://127.0.0.1:5000/parts/graphics_cards',
          {
            params: {'id': this.id}
          }
        )
